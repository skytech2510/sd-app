...
const breadcrumb = ref({
  ...
  link: { id: 1, name: "Coleção", url: "/colecao" },
});

watch(term, (value) => {
  router.get("/colecao", { term: value });
});
...
function destroy(collection) {
  if (confirm("Confirma a exclusão desta coleção?")) {
    form.delete(route("collection.destroy", collection));
  }
}
</script>
      ...
      <div class="bg-white">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div class="grid grid-cols-7 gap-3 px-4 py-6 text-slate-600">
            <div class="">
              <ButtonLink variant="primary" class="block" value="/colecao/criar"
                >NOVO
              </ButtonLink>
            </div>
          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="px-6 font-light">Fornecedor</th>
            ...
            <tbody>
              ...
              >
               ...
               <td class="flex justify-end px-6 py-4">
                  <ButtonLink
                    variant="basic"
                    :href="`/colecao/${collection.id}/editar`"
                    class=""
                  >
                    <svg
