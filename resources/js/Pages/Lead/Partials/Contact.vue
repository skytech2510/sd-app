...
<template>
    ...
    <div class="mt-4 text-sm space-y-4">
        <!--<div v-if="$page.props.user.roles[0] === 'admin' ? true : false">-->
        <div>
        ...
        <!--<div v-else>
            <div 
                ...
                <div v-if="funnelStep.id === lead.funnel_step_id" :class="`my-2 px-4 py-2 border border-${funnelStep.color}-500 text-${funnelStep.color}-500 font-semibold rounded-md`">
                    <span>{{funnelStep.name}}</span>
                </div>
            </div>
        </div>-->
        <div v-if="$page.props.user.roles[0] === 'admin'" class="">
