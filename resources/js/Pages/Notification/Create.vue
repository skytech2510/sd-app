...
const breadcrumb = ref({
  ...
  link: { id: 1, name: "Notificações", url: "/notificacao" },
});
const form = useForm({
  title: null,
  message: null,
      ...
      <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          <form @submit.prevent="storeNotification">
            ...
            <div class="grid grid-cols-1 pt-5 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="space-x-2 sm:col-span-4">
                ...
                <ButtonLink variant="default" class="" value="/notificacao"
                  >VOLTAR
                </ButtonLink>
              </div>
            </div>
