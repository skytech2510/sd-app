...
const breadcrumb = ref({
  ...
  link: { id: 1, name: "Tecido", url: "/tecido" },
});

watch(term, (value) => {
  router.get("/tecido", { term: value });
});
...
function destroy(fabric) {
  if (confirm("Confirma a exclusão deste tecido?")) {
    form.delete(route("fabric.destroy", fabric));
  }
}
</script>
      ...
      <div class="bg-white">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div class="grid grid-cols-7 gap-3 px-4 py-6 text-slate-600">
            <div class="">
              <ButtonLink variant="primary" class="block" value="/tecido/criar"
                >NOVO
              </ButtonLink>
            </div>
          ...
          >
            ...
            >
              <tr>
                ...
                <th scope="col" class="px-6 font-light">Cód.</th>
                <th scope="col" class="px-6 font-light">Nome</th>
                <th scope="col" class="px-6 font-light">Coleção</th>
                <th scope="col" class="px-6 font-light">Largura</th>
                <th scope="col" class="px-6 font-light">Preço</th>
                <th scope="col" class="px-6 font-light">Atualização</th>
            ...
            <tbody>
              ...
              >
                ...
                <td scope="row" class="px-6">
                  {{ moment(fabric.updated_at).format("DD/MM/YYYY") }}
                </td>

                <td class="flex justify-end px-6 py-4">
                  <ButtonLink
                    variant="basic"
                    :href="`/tecido/${fabric.id}/editar`"
                    class=""
                  >
                    <svg
