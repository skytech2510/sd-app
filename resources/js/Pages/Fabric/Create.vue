...
function calc() {
  // let cost = unformat(form.cost, config);
  // let discount = unformat(form.discount, config);
  // let IPI = unformat(form.IPI, config);
  // let ST = unformat(form.ST, config);
  // let shipping = unformat(form.shipping, config);
      ...
      <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
          <form @submit.prevent="store">
              ...
              <div class="mt-3 grid grid-cols-1 sm:grid-cols-12 gap-4">
                ...
                <div class="sm:col-span-2">
                  <TextInput
                    ...
                    placeholder=""
                  />
                  <div v-if="form.errors.fabric_width" class="text-sm text-red-500 mt-2">
                    {{ form.errors.fabric_width }}
                  </div>
                </div>
            ...
            <div class="pt-6 grid grid-cols-1 grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
