...
const breadcrumb = ref({
  ...
  link: { id: 1, name: "Fabricante", url: "/fabricante" },
});
...
function destroy(manufacturer) {
  if (confirm("Confirma a exclusão deste fabricante?")) {
    form.delete(route("manufacturer.destroy", manufacturer));
  }
}
</script>
      ...
      <div class="bg-white">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
          <div class="grid grid-cols-7 gap-3 px-4 py-6 text-slate-600">
            <div class="">
              <ButtonLink variant="primary" class="block" value="/fabricante/criar"
                >NOVO
              </ButtonLink>
            </div>
            ...
            <tbody>
              ...
              >
                ...
                <td class="flex justify-end px-6 py-4">
                  <ButtonLink
                    variant="basic"
                    :href="`/fabricante/${manufacturer.id}/editar`"
                    class=""
                  >
                    <svg
