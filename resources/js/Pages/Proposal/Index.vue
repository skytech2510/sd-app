                    ...
                    >
                        ...
                        >
                            <tr>
                                ...
                                <th v-if="$page.props.user.roles[0] === 'admin'" scope="col" class="px-4 font-light">
                                    Usuário
                                </th>
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td v-if="$page.props.user.roles[0] === 'admin'"
                                    scope="row"
                                ...
                                <td class="flex space-x-2 py-3 px-4">
                                    ...
                                    <Button
                                        v-if="proposal.status_id === 11 && $page.props.user.roles[0] === 'admin'"    
                                        variant="basic"
                                    ...
                                    <Button
                                        v-if="proposal.status_id === 4 && $page.props.user.roles[0] === 'admin'"    
                                        variant="basic"
                                    ...
                                    <Button
                                        v-if="(proposal.status_id === 11 || proposal.status_id === 13) && $page.props.user.roles[0] === 'admin'"    
                                        variant="basic"
