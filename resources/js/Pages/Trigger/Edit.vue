...
const breadcrumb = ref({
  ...
  link: { id: 2, name: "Acionamento", url: "/acionamento" },
});
...
function update() {
  form.put(route("trigger.update", props.trigger.id));
}
</script>
          ...
          <form @submit.prevent="update">
            ...
            <div class="pt-6 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div class="sm:col-span-4 space-x-2">
                ...
                <ButtonLink variant="default" class="" value="/acionamento"
                  >VOLTAR
                </ButtonLink>
              </div>
            </div>
